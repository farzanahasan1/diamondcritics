          ...
          {[1, 2, 3, 4, 5].map(i => (
            <div key={i} style={{
              ...
              <div style={{ flex: 1, padding: '12px 16px' }}>
                ...
                <div style={{ width: '85%', height: 16, borderRadius: '4px', background: '#EDE8E1', marginBottom: '6px', animation: 'skeleton-pulse 1.4s ease-in-out infinite' }} />
                <div style={{ width: '60%', height: 16, borderRadius: '4px', background: '#EDE8E1', marginBottom: '10px', animation: 'skeleton-pulse 1.4s ease-in-out infinite' }} />
                <div style={{ width: 80, height: 12, borderRadius: '4px', background: '#F0ECE5', animation: 'skeleton-pulse 1.4s ease-in-out infinite' }} />
              </div>
            </div>
          ))}
