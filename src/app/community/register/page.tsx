    ...
    <div className="min-h-[calc(100vh-3.5rem)] flex items-stretch -mt-5 -mx-4">
      ...
      >
        <Link href="/community" className="flex items-center gap-2.5 group">
          <div className="w-8 h-8 rounded-full flex items-center justify-center" style={{ background: 'linear-gradient(135deg, #C6973E 0%, #e8bf6a 50%, #9a7030 100%)' }}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
              <path d="M6 3L2 9l10 12L22 9l-4-6H6z" stroke="white" strokeWidth="1.5" strokeLinejoin="round"/>
              <path d="M2 9h20M6 3l3 6m6-6l-3 6" stroke="white" strokeWidth="1.5" strokeLinejoin="round"/>
            </svg>
          </div>
          <span className="text-sm font-semibold" style={{ color: '#e8c97a' }}>Diamond Community</span>
        </Link>
        ...
        <div>
          ...
          >
            The place for diamond lovers to connect
          </h2>
          <p className="text-sm leading-relaxed mb-8" style={{ color: 'rgba(245,230,200,0.55)' }}>
            Ask questions, share finds, get expert opinions — all in one community dedicated to diamonds and fine jewellery.
          </p>

          <div className="space-y-4">
            {[
              { icon: '✦', text: 'Real advice from diamond enthusiasts' },
              { icon: '✦', text: 'Share your engagement ring stories' },
              { icon: '✦', text: 'Compare diamonds before you buy' },
            ].map(item => (
      ...
      <div className="flex-1 flex items-center justify-center bg-white px-6 py-10">
        <div className="w-full max-w-[380px]">
          ...
          <p className="text-sm mb-7" style={{ color: '#888' }}>Join the diamond community today</p>
          ...
          <div className="relative my-5">
            ...
            <div className="relative flex justify-center">
              <span className="bg-white px-3 text-xs" style={{ color: '#aaa' }}>or sign up with email</span>
            </div>
          </div>

          <form action={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="username" className="block text-xs font-medium mb-1.5" style={{ color: '#555' }}>
                Username <span style={{ color: '#aaa', fontWeight: 400 }}>(public — never your email)</span>
              </label>
              <input
                id="username"
                name="username"
              ...
              />
              <p className="text-xs mt-1" style={{ color: '#bbb' }}>3–20 chars, letters / numbers / underscores</p>
            </div>

            <div>
              <label htmlFor="email" className="block text-xs font-medium mb-1.5" style={{ color: '#555' }}>
                Email <span style={{ color: '#aaa', fontWeight: 400 }}>(private — never shown)</span>
              </label>
              <input
                id="email"
                name="email"
            ...
            <div>
              ...
              <input
                ...
                onBlur={e => (e.currentTarget.style.borderColor = '#e5e5e3')}
              />
              <p className="text-xs mt-1" style={{ color: '#bbb' }}>Minimum 8 characters</p>
            </div>
          ...
          <p className="text-center text-sm mt-5" style={{ color: '#888' }}>
            ...
            <Link href="/community/login" className="font-semibold hover:underline" style={{ color: '#C6973E' }}>
              Log in
            </Link>
          </p>
